...
bindsym XF86KbdBrightnessUp exec --no-startup-id xbacklight -ctrl asus::kbd_backlight -inc 20
bindsym XF86KbdBrightnessDown exec --no-startup-id xbacklight -ctrl asus::kbd_backlight -dec 20
...
mode "$mode_system" {
    bindsym l exec --no-startup-id betterlockscreen -l pixel -t "locked.", mode "default"
...
###################SCREENSHOT######################
set $mode_screenshot (f)ullscreen, (s)election, (c)lipboard 
mode "$mode_screenshot" {
    bindsym f exec --no-startup-id flameshot full -p ~/Pictures/screenshots, mode "default"
    bindsym s exec --no-startup-id flameshot gui -p ~/Pictures/screenshots, mode "default"
    bindsym c exec --no-startup-id flameshot full -c, mode "default"
