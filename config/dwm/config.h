...
static const char *upmon[] = { "xbacklight", "-inc", "10", NULL };
static const char *downmon[] = { "xbacklight", "-dec", "10", NULL };
static const char *upkbd[] = { "xbacklight", "-ctrl", "asus::kbd_backlight", "-inc", "20", NULL };
static const char *downkbd[] = { "xbacklight", "-ctrl", "asus::kbd_backlight", "-dec", "20", NULL };
